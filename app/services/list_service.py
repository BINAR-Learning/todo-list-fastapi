...
class ListService:
    ...
    def get_list_by_id(self, list_id: str, user: User) -> Optional[List]:
        """
        Mendapatkan list berdasarkan ID dan user
        """
    ...
    def update_list(self, list_id: str, list_data: ListUpdate, user: User) -> Optional[List]:
        """
        Update list berdasarkan ID dan user
        """
    ...
    def delete_list(self, list_id: str, user: User) -> bool:
        """
        Hapus list berdasarkan ID dan user
        """
        db_list = self.get_list_by_id(list_id, user)
        if not db_list:
            raise HTTPException(
