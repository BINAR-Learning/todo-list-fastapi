...
def get_current_user_basic(
    ...
    user = auth_service.authenticate_user_email(credentials.username, credentials.password)
...
def get_current_active_user(current_user: User = Depends(get_current_user_flexible)) -> User:
    """
